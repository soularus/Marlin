...
#define STRING_CONFIG_H_AUTHOR "(soularus, skr-mini-e3-bugfix-2.0.6.1)" // Who made the changes.
...
#define Z_PROBE_SPEED_FAST (8*60) //Default (4*60)
...
#define X_BED_SIZE 180  //Due to Hemera
